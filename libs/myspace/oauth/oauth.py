...
# comparater function to account for myspace sorting upper case after lower
# case but default python sort doing to opposite.
def cmp (x, y):
  if x[0][0].islower() and y[0][0].isupper():
    return -1

  if x[0][0].isupper() and y[0][0].islower():
    return 1

  return x[0] > y[0] and 1 or x[0] < y[0] and -1 or 0
